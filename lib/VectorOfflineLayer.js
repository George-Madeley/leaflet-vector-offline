...
const themes_1 = require("protomaps-leaflet/src/default_style/themes");
...
class VectorOfflineLayer extends L.GridLayer {
    ...
    getTileUrls(bounds, zoom) {
        var _a;
        const tiles = [];
        const tilePoints = (0, TileManager_1.getTilePoints)(bounds, this.getTileSize());
        for (let index = 0; index < tilePoints.length; index += 1) {
            ...
            tiles.push({
                key: (0, TileManager_1.getTileUrl)(this._url, Object.assign(Object.assign({}, data), { s: (_a = this.options.subdomains) === null || _a === void 0 ? void 0 : _a[0] })),
                url: (0, TileManager_1.getTileUrl)(this._url, Object.assign(Object.assign({}, data), { 
                    // @ts-ignore: Undefined
    ...
    _getStorageKey(coords) {
        return (0, TileManager_1.getTileUrl)(this._url, Object.assign(Object.assign(Object.assign({}, coords), this.options), { 
